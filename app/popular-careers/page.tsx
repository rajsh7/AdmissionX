      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 pb-12">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            ...
            { href: "/colleges", icon: "apartment", label: "Top Colleges", desc: "Find colleges for your career", iconBg: "bg-blue-50", iconColor: "text-blue-600", border: "hover:border-blue-200", arrow: "group-hover:text-blue-600" },
            { href: "/careers-courses", icon: "menu_book", label: "Top Courses", desc: "Explore courses for your career", iconBg: "bg-emerald-50", iconColor: "text-emerald-600", border: "hover:border-emerald-200", arrow: "group-hover:text-emerald-600" },
