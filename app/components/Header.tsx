...
export default function Header({ onLoginClick, onRegisterClick }: HeaderProps) {
  ...
  return (
    <>
      ...
      <motion.header
        className="fixed top-4 left-1/2 -translate-x-1/2 z-50 w-[95%] max-w-7xl bg-white backdrop-blur-xl border border-neutral-200 rounded-full shadow-lg shadow-black/10 transition-colors"
      >
