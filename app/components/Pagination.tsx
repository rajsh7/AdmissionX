  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="flex items-center gap-1.5 px-3 py-2 rounded-xl text-sm font-semibold text-neutral-600 bg-white border border-neutral-200 hover:border-red-300 hover:text-red-600 hover:bg-red-50 disabled:opacity-40 disabled:pointer-events-none transition-all duration-200"
      >
            ...
            <button
              ...
              className={`w-9 h-9 rounded-xl text-sm font-bold transition-all duration-200 ${
                p === currentPage
                  ...
                  : "bg-white border border-neutral-200 text-neutral-600 hover:border-red-300 hover:text-red-600 hover:bg-red-50"
              }`}
            >
              {p}
            </button>
