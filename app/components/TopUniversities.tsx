      ...
      <div className="mx-auto max-w-[1920px] px-6 sm:px-12 lg:px-24">
        <div className="mb-12">
          <h2 className="text-[36px] lg:text-[48px] font-black text-slate-900 tracking-tight leading-tight">
            Discover the Top{" "}
            <span className="text-[#008080]">Universities</span>
          </h2>
        ...
        {/* Universities Grid */}
        <div
          className={`grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 transition-opacity duration-300 ${isLoading ? "opacity-50 pointer-events-none" : "opacity-100"}`}
        >
