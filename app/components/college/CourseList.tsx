...
export default function CourseList({ courses, collegeName }: CourseListProps) {
  if (courses.length === 0) {
    return (
      <section className="bg-white rounded-2xl border border-neutral-100 p-12 flex flex-col items-center text-center">
  ...
  const streamColors = [
    ...
    { dot: "bg-blue-500",   badge: "bg-blue-50 text-blue-700 border-blue-100" },
    ...
    { dot: "bg-pink-500",   badge: "bg-pink-50 text-pink-700 border-pink-100" },
  ];
  ...
  return (
    <section className="bg-white rounded-2xl border border-neutral-100 overflow-hidden">
      ...
      {/* Stream tabs summary */}
      <div className="px-6 py-3 flex flex-wrap gap-2 border-b border-neutral-50">
                  ...
                  <tbody>
                    {cs.map((course, i) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-3">
                          {course.degree_name ? (
                            <span className="inline-flex items-center px-2 py-0.5 rounded-md bg-neutral-100 text-neutral-600 text-xs font-semibold">
                              {course.degree_name}
                            </span>
                          ) : (
