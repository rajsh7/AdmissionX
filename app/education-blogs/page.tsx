      ...
      <div className="relative z-10">
        ...
        <div className="w-full px-4 lg:px-8 xl:px-12 pb-12">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              { href: "/news", icon: "newspaper", label: "Education News", desc: "Latest admission & exam alerts", iconBg: "bg-blue-50", iconColor: "text-blue-600", border: "hover:border-blue-200", arrow: "group-hover:text-blue-600" },
