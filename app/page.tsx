  ...
  async () => {
    try {
      ...
      const [collegeRows, blogRows, examRows, adRows, collegeCount, studentCount, countryCount, courseCount] = await Promise.all([
        ...
        db.collection("blogs").find({ isactive: 1 }).sort({ created_at: -1 }).limit(8).project({ _id: 0, id: 1, topic: 1, featimage: 1, fullimage: 1, image: 1, description: 1, slug: 1, created_at: 1, author_name: 1, author_image: 1, read_time: 1 }).toArray() as Promise<DbBlog[]>,
