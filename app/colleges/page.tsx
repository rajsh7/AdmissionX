      ...
      <main className="flex-1 max-w-5xl w-full mx-auto px-4 py-8 mt-16">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mt-10">
          {[
            ...
            { href: "/stream", icon: "category", label: "Streams", desc: "Find your stream & specialisation", iconBg: "bg-blue-50", iconColor: "text-blue-600", border: "hover:border-blue-200", arrow: "group-hover:text-blue-600" },
          ].map((card) => (
            <a
              key={card.href}
              href={card.href}
